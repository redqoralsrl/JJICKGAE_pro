...
<head>
    ...
    <!-- <script>
        function del(href){
            if(confirm('한번 삭제한 자료는 복구방법이 없습니다\n\n정말 삭제하시겠습니까?')){
    ...
    <div class="colbody">
        <div class="col2">
            ...
            <div class="view_title">
                <div class="view_title2">닉네임 : <?=$item_nick?> | 조회 : <?=$item_hit?> | 날짜 : <?=$item_date?></div>
            </div><!--view_title-->
            <div class="line_s"></div>
            <div class="view_content">
                <div class="content_view">내용</div>
            ...
            <div class="ripple">
                ...
                <div class="ripple_writer_title">
                    <ul>
                        <li class="writer_title1">닉네임 : <?=$ripple_nick?></li>
                ...
                ?>
                <div class="line_s"></div>
                <form name="ripple_form" method="post" action="../boardFree/insert_ripple.php?num=<?=$item_num?>&?page=<?=$page?>">
                    <div class="ripple_box">
                        <div class="ripple_box1">덧글쓰기</div>
                        <div class="ripple_box2"><textarea name="ripple_content" cols="65" rows="5"></textarea></div>
                    </div><!-- ripple_box -->
                    <div class="ripple_box3"><input type="submit" value="덧글쓰기"></div>
                </form>
            </div><!--ripple-->
