...
<body>
    ...
    <?php
        ...
        while($row = mysqli_fetch_array($result)){
            ...
            $board_free_content = str_replace(" ", "&nbsp;",$row['content']);
    ?>
                ...
                <ul>
                    ...
                    <li class="writer_titled4">
                        <?php
                            ...
                            print("<a href='../board/delete_board.php?num=$board_free_num&page=$page'>[삭제]</a>");
                                }
                            }
        ?>
                    </li>
                        ...
                        <ul class="uls">
                            ...
                            <li class="mdi_del">
                                <?php
                                    ...
                                    print("<a href='../board/delete_ripple.php?num=$ripple_num&page=$page'>[삭제]</a>");
                                        }
                                    }
                                ?>
                            </li>
